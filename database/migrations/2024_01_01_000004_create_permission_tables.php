...
// After `composer install`, you can instead run:
// php artisan vendor:publish --provider="Spatie\Permission\PermissionServiceProvider" --tag="permission-migrations"
// and delete this file to always match the installed package version.
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $teams) {
            ...
            if ($teams) {
                ...
                $table->primary([config('permission.column_names.team_foreign_key'), $pivotPermission, $columnNames['model_morph_key'], 'model_type'], 'model_has_permissions_permission_model_type_primary');
            } else {
        ...
        Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole, $teams) {
            ...
            if ($teams) {
                ...
                $table->primary([config('permission.column_names.team_foreign_key'), $pivotRole, $columnNames['model_morph_key'], 'model_type'], 'model_has_roles_role_model_type_primary');
            } else {
